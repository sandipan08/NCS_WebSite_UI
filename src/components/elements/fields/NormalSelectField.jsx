...
export default function NormalSelectField({ field, value, isViewMode, index, register, errors, changeHandler, blurHandler }) {
    ...
    return (
        <Form.Group key={index} as={Col} md={'4'} className="mb-2">
            ...
            <Form.Select size='sm' style={{ width: '250px' }} // input
                // readOnly={isViewMode}
